  ...
  context 'instance methods' do
    ...
    describe "#walk_dogs" do
      it "walks the dogs which makes the dogs' moods happy" do
        #Code Answer is inferred from line above in English
        dog = Dog.new("Daisy")#instantiates an new Dog. Ruby code ==?
        #binding.pry
        owner.pets[:dogs] << dog#appends a new dog to dog key. Ruby code ==?
        #binding.pry
        owner.walk_dogs#owner call walk_dogs instance method
        #binding.pry
        expect(dog.mood).to eq("happy")#assigns Dog object instance = "happy". Ruby code ==?
      end
    end
